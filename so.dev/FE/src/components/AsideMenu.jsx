...
const AsideMenu = () => {
  ...
  return (
    <div className="flex flex-col sticky w-50 h-screen top-0 bg-(--secondary)">
        ...
        >
          <MdHome className="mr-2" size={24} color={darkMode ? "white" : "black"} /> Home
        </button>
        <button
          onClick={() => navigate("/profile")}
          className="flex items-center  pl-5  h-10 hover:bg-(--primary) rounded-full"
        >
          <CgProfile className="mr-2" size={24} color={darkMode ? "white" : "black"} /> Profile
        </button>
        ...
        >
          <button className="h-10 pl-3 w-full text-left hover:bg-(--primary) rounded-full">Edit Profile</button>
          <button className="h-10 pl-3 w-full text-left hover:bg-(--primary) rounded-full">Privacy</button>
          <button className="h-10 pl-3 w-full text-left hover:bg-(--primary) rounded-full">Notification</button>
          <button className="h-10 pl-3 w-full text-left hover:bg-(--primary) rounded-full">Help</button>
          <button className="h-10 pl-3 w-full text-left hover:bg-(--primary) rounded-full">About</button>
           <Toggle/>
        </motion.div>
